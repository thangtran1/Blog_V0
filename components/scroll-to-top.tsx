  ...
  return (
    ...
    >
      <Button
        onClick={scrollToTop}
        size="icon"
        className={`w-14 h-14 rounded-full ${bgDefault2} hover:from-blue-600 hover:to-blue-700 text-white shadow-2xl hover:shadow-green-500/25 transition-all duration-300 hover:scale-110 group relative overflow-hidden`}
      >
        {/* Animated background */}
